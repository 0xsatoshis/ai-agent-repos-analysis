...
`🏢 JCodesMore` `Stars: 15.5k` `MIT；API 可能收费` `更新: 2026-05-07`

站点克隆工作流可参考；依赖 SaaS/API

**14.** **[nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill)** — UIUX 提示技能
`🏢 Next Level Builder` `Stars: 83.2k` `MIT` `更新: 2026-04-03`
